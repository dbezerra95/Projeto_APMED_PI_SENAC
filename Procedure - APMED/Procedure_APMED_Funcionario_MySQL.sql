...
# Script responsável por chamar a procedure
CALL apmed2.prc_inserir_funcionario_apmed(NULL , '137.112.700-99', 'Neide Vilariça Brásio', '1987-6-07', 'Africana', 'F', 
'Atendente', 'Carinha que mora logo ali', '(61) 9 9344-6464', 'neide@atendente.com', 1, 1, NULL, NULL);

SELECT * FROM funcionario_bk;
...
# Script responsável por chamar a procedure
CALL apmed2.prc_update_funcionario_apmed(3, '75495-45', '828.656.600-95', 'Ary Barros Sousa', '1993-09-12', 'Americano', 'M', 
'Enfermeiro', 'Karolina do Sul', '(61) 9 9344-6464', 'aryB@enfermeiro.com', NULL, NULL, 1, 1);
...
# Script responsável por chamar a procedure
CALL apmed2.prc_delete_funcionario_apmed(3);
