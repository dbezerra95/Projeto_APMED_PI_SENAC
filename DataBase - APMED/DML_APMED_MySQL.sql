...
INSERT INTO comprovante (desc_comp,	data_comp, hora_comp, funcionario_id_func, pagamento_id_pgto, consulta_id_cons,	paciente_convenio_id_conv,
...
INSERT INTO comprovante (desc_comp,	data_comp, hora_comp, funcionario_id_func, pagamento_id_pgto, consulta_id_cons,	paciente_convenio_id_conv,
	consulta_paciente_id_pac, consulta_medico_id_med, consulta_paciente_setor_id_setor,	consulta_paciente_setor_hospital_id_hosp)
VALUES ('Documento para comprovação fiscal', 20211212, 165500, 2, 2, 2, NULL, 2, 2, 2, 2);

INSERT INTO comprovante (desc_comp,	data_comp, hora_comp, funcionario_id_func, pagamento_id_pgto, consulta_id_cons,	paciente_convenio_id_conv,
	consulta_paciente_id_pac, consulta_medico_id_med, consulta_paciente_setor_id_setor,	consulta_paciente_setor_hospital_id_hosp)
VALUES ('Documento para comprovação fiscal', 20210504, 120000, 3, 3, 3, NULL, 3, 3, 3, 3);